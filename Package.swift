...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.309/EOCore_XCFramework_Debug.zip",
            checksum: "a7762e32b83284f4abec7e6e42d3dab4cd3bb5ed53ebf564e2ddf44e59179efc"),
    ]
)
