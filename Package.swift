...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.125/Tealeaf_XCFramework_Debug.zip",
            checksum: "ef70917b6f55783012c1fb4db10ea755c82fe1d0d22bd4b62eedb250bd7936e6"),
        .binaryTarget(
            name: "EOCore",
