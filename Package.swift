...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.203/Tealeaf_XCFramework_Debug.zip",
            checksum: "bf0b5dd09109da21826eaedbb851fe7c4c0282d3fea5a2bcee0accf0ff1fcaef"),
        .binaryTarget(
            name: "EOCore",
