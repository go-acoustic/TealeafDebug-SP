...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.283/EOCore_XCFramework_Debug.zip",
            checksum: "34765501f7fabd5494f24791e25e63a9d42ddbce5b5a37d5d4e9304971d4d045"),
    ]
)
