...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.276/EOCore_XCFramework_Debug.zip",
            checksum: "736c96ad8f7a22354456f4183a1324ea9d07209ff72884a42d86cef642f60b76"),
    ]
)
