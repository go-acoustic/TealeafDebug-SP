...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.222/Tealeaf_XCFramework_Debug.zip",
            checksum: "9928e867239ee90a99adfc0ee20139f6091ebdb71776b46370f4ea0f3c1a3a72"),
        .binaryTarget(
            name: "EOCore",
