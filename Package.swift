...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.198/Tealeaf_XCFramework_Debug.zip",
            checksum: "38e01cad0d5d465651db1aaea1dcd34c61063fc32258c0984259bd50bcc1886e"),
        .binaryTarget(
            name: "EOCore",
