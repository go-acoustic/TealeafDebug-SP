...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/go-acoustic/Tealeaf/releases/download/10.6.333/Tealeaf_XCFramework_Debug.zip",
            checksum: "249ca17ef3cdd95dc9c3a964c2631b75bf159511bd1ec7f0cbb270eb4d1206f8"),
        .binaryTarget(
            name: "EOCore",
