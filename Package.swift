...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.152/Tealeaf_XCFramework_Debug.zip",
            checksum: "279bff70bf3b2ecdb00d7bceaf589f7fdd95c28af536e146b605871e9addd476"),
        .binaryTarget(
            name: "EOCore",
