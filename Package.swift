...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.245/Tealeaf_XCFramework_Debug.zip",
            checksum: "de0a50b4d0e4f5dacc284338ddca3ba4c1fb2d6dfd8a6b4c79440dfeb75da477"),
        .binaryTarget(
            name: "EOCore",
