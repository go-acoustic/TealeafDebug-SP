...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.265/Tealeaf_XCFramework_Debug.zip",
            checksum: "89605e04fc4e38b81ec6b700271e36134bcd2be89913b5e5916d386cf96b3867"),
        .binaryTarget(
            name: "EOCore",
