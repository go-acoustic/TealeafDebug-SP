...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.91/Tealeaf_XCFramework_Debug.zip",
            checksum: "cb4f19399166b4c27cb24304ce38d0c95f756aae89ae2d28275988cd4ef695ab"),
        .binaryTarget(
            name: "EOCore",
