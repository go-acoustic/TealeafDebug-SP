...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/acoustic-analytics/EOCore/releases/download/2.3.69/EOCore_XCFramework_Debug.zip",
            checksum: "5edb696dfba82d77ba36dcc9976b0bcb4893909bd77e9889fa1f84609ec72e4b"),
    ]
)
