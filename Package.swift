...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.96/Tealeaf_XCFramework_Debug.zip",
            checksum: "4ab3543a923a3b1876a832c83a04a681d094f57cc1f0c55ccc47486260eaba78"),
        .binaryTarget(
            name: "EOCore",
