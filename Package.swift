...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.169/Tealeaf_XCFramework_Debug.zip",
            checksum: "c16b51313fe9674e0872f552f06b9e0fbf17f2ee1cfdaffdb5a3d4c2d56914a9"),
        .binaryTarget(
            name: "EOCore",
