...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.266/Tealeaf_XCFramework_Debug.zip",
            checksum: "6c7a46ac32a9a0a461425646687aab65dd0e730e790a79099028df69b82e807b"),
        .binaryTarget(
            name: "EOCore",
