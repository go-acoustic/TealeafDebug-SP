...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.106/Tealeaf_XCFramework_Debug.zip",
            checksum: "abe2dce9d3ce851c4d6202f95ec9d3113555244387539e26d2fbb7174583462f"),
        .binaryTarget(
            name: "EOCore",
