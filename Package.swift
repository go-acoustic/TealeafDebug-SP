...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/go-acoustic/Tealeaf/releases/download/10.6.287/Tealeaf_XCFramework_Debug.zip",
            checksum: "e5932d9730a5f2efeca415d2718576bb5cef764993df89f0df6ffee071bee118"),
        .binaryTarget(
            name: "EOCore",
