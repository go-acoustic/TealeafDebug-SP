...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.159/Tealeaf_XCFramework_Debug.zip",
            checksum: "1b8226a3223f13ea0c1439f465fc1873e9685741869ca4d663ac680cc65ea186"),
        .binaryTarget(
            name: "EOCore",
