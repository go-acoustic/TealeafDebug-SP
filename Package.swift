...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/acoustic-analytics/EOCore/releases/download/2.3.262/EOCore_XCFramework_Debug.zip",
            checksum: "9672640dbada60ee5772c135305bbbe82951d03503dbc6e8523d4e62b4322c19"),
    ]
)
