...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/acoustic-analytics/EOCore/releases/download/2.3.49/EOCore_XCFramework_Debug.zip",
            checksum: "b0d3b2217b7c79bbf34209797dad0cff81c4c3a3fa530ea9ed929b8625a96501"),
    ]
)
