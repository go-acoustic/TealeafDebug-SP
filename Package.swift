...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/acoustic-analytics/EOCore/releases/download/2.3.266/EOCore_XCFramework_Debug.zip",
            checksum: "d084a8232ef360e439e038fbd593c4538ee49807ce8dc772cc65f3f3f7d844a6"),
    ]
)
