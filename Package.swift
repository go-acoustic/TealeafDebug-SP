...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.128/Tealeaf_XCFramework_Debug.zip",
            checksum: "e8bad44a080fb9526c7b30cd3f76c066aff3f7aa34bbea2704d7990d76a46e55"),
        .binaryTarget(
            name: "EOCore",
