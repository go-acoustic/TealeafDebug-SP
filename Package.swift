...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.94/Tealeaf_XCFramework_Debug.zip",
            checksum: "20edfd75ff8463a95be2dc908835dfb2c36fc82ebc57c64aac13e41a0f513ac2"),
        .binaryTarget(
            name: "EOCore",
