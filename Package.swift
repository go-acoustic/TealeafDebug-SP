...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.241/Tealeaf_XCFramework_Debug.zip",
            checksum: "d3cc3215ef3dba00bba6d2d872c89f0a78a7f8e196875d22367517141bab8b50"),
        .binaryTarget(
            name: "EOCore",
