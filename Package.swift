...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.93/Tealeaf_XCFramework_Debug.zip",
            checksum: "10a81ce8fae2394dc134e2ab32cc48a82d35abd11d785e12d4e9e53cde48cb8e"),
        .binaryTarget(
            name: "EOCore",
