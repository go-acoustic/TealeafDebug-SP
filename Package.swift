...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.337/EOCore_XCFramework_Debug.zip",
            checksum: "13a5c49218688339b183a7044389558997e25b8a2628a2a88f06b570d07153a2"),
    ]
)
