...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.103/Tealeaf_XCFramework_Debug.zip",
            checksum: "0db059b629fdc4fa00eafb655e5fcbf88aef1c46a488fd6614da85bfadbd869e"),
        .binaryTarget(
            name: "EOCore",
