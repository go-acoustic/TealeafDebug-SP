...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.127/Tealeaf_XCFramework_Debug.zip",
            checksum: "bbdf38d53ed6acbb354283d4e64df8fe30897a5cb15a67a848f4549b06bcd6d8"),
        .binaryTarget(
            name: "EOCore",
