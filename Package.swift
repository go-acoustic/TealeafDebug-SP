...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/acoustic-analytics/EOCore/releases/download/2.3.187/EOCore_XCFramework_Debug.zip",
            checksum: "2b568a147ef498b644f032fbbdec6b5cad4296f7bbcccc179483f29a123bfe9c"),
    ]
)
