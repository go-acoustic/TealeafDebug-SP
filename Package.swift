...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.132/Tealeaf_XCFramework_Debug.zip",
            checksum: "b416da29739f408e2d5d9c50ed5788884fb195b97255886f613a45b9d89646b7"),
        .binaryTarget(
            name: "EOCore",
