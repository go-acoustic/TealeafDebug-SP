...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/acoustic-analytics/EOCore/releases/download/2.3.46/EOCore_XCFramework_Debug.zip",
            checksum: "9e4c342614f134e61c7fd34266502b5dd7dd1f76930f78ef92bc054469a47d49"),
    ]
)
