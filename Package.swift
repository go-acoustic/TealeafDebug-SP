...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.97/Tealeaf_XCFramework_Debug.zip",
            checksum: "e3010e11f929aff97efa1de4a329bfd4d7c5fdfeb6ef61df8548073024f942db"),
        .binaryTarget(
            name: "EOCore",
