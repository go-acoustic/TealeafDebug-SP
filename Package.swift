...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/acoustic-analytics/EOCore/releases/download/2.3.195/EOCore_XCFramework_Debug.zip",
            checksum: "fdd67ba51474eb977015503368bead5858384bd351b57e2cd8bffb42b227c2d3"),
    ]
)
