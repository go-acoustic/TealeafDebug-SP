...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.104/Tealeaf_XCFramework_Debug.zip",
            checksum: "033d6363f78692a268d86e7eed6cc73e92c5584169c7467776961fe428c99ee7"),
        .binaryTarget(
            name: "EOCore",
