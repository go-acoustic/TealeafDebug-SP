...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.102/Tealeaf_XCFramework_Debug.zip",
            checksum: "20409f6d421b01a92e348776716d47b5f147ac353224331ee751bedfa147afaa"),
        .binaryTarget(
            name: "EOCore",
