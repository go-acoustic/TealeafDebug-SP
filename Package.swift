...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.336/EOCore_XCFramework_Debug.zip",
            checksum: "ee93b6e008714e3c36ed52147f36bfac171df2dc81714067a45ac59053de7a38"),
    ]
)
