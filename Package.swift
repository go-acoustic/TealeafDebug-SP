...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.240/Tealeaf_XCFramework_Debug.zip",
            checksum: "aa476385b41a14a16bb4da6541f3d3f42e25275f864d83f00b872c92a32bf345"),
        .binaryTarget(
            name: "EOCore",
