...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.281/EOCore_XCFramework_Debug.zip",
            checksum: "1c0b0163b85d422eef3e7b7893003de1efbf50a7451d398d913d8042050d1535"),
    ]
)
