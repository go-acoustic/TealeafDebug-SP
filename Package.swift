...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.304/EOCore_XCFramework_Debug.zip",
            checksum: "8dde823af578cf2e648c6b4519f0d07da1744dcebe17cfcd5c59d1e8d1167d33"),
    ]
)
