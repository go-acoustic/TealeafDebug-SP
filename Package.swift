...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.274/EOCore_XCFramework_Debug.zip",
            checksum: "786af18fe953f86343bc0439d3eac6f7f6a88dbdab47856356d68de9c16751da"),
    ]
)
