...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.134/Tealeaf_XCFramework_Debug.zip",
            checksum: "7e06c4abb963905109df2057c030d87380c0d5c2a8d19a9fea9c65b76f1e5399"),
        .binaryTarget(
            name: "EOCore",
