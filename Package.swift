...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.191/Tealeaf_XCFramework_Debug.zip",
            checksum: "7e2f6ef553c621ce6947fe62df7165ba240f37bf410ae28ba2c202ba68577505"),
        .binaryTarget(
            name: "EOCore",
