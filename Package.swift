...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.264/Tealeaf_XCFramework_Debug.zip",
            checksum: "c2d0b9a7a16605ae75e5f3233ecfed44075018327cece493c31ab939f06a6b92"),
        .binaryTarget(
            name: "EOCore",
