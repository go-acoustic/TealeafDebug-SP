...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.303/EOCore_XCFramework_Debug.zip",
            checksum: "a7fecdb9f802dc9b8b0016b06f8d44f2a32481477edfabd3c0c76b3d1e453e0e"),
    ]
)
