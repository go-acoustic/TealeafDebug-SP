...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.87/Tealeaf_XCFramework_Debug.zip",
            checksum: "bac98979ea04b4590b3860e4d7e606a6a2e214ed53c7b90e8b037448cc1c376f"),
        .binaryTarget(
            name: "EOCore",
