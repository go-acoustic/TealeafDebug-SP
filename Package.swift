...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.126/Tealeaf_XCFramework_Debug.zip",
            checksum: "9631609d306349091b2b117bd79397ea64427e54f9c68279891f8e0007f832aa"),
        .binaryTarget(
            name: "EOCore",
