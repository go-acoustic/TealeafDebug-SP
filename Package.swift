...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.316/EOCore_XCFramework_Debug.zip",
            checksum: "097e663980d6ee98dd6b628b07c7218de4348e57858676faa6b17f755af1dd71"),
    ]
)
