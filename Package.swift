...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/go-acoustic/Tealeaf/releases/download/10.6.321/Tealeaf_XCFramework_Debug.zip",
            checksum: "4becd2ba9a7e783eadbefb64e95d74c6a5c5c087ba45e8b6506f20cf062764f7"),
        .binaryTarget(
            name: "EOCore",
