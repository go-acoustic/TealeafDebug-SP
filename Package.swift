...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.279/EOCore_XCFramework_Debug.zip",
            checksum: "bcd7ef2ddd750cb0fbb46bdee75406d35d5b6e453f9abc49023cd73e7661ba30"),
    ]
)
