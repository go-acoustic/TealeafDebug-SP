...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.217/Tealeaf_XCFramework_Debug.zip",
            checksum: "96274146f7c1bbc421d95f469d74dc2d1c8cdd1aa384e3e0855e2b344a93c60a"),
        .binaryTarget(
            name: "EOCore",
