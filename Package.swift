...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.131/Tealeaf_XCFramework_Debug.zip",
            checksum: "66071e47c0907108664e1850e855a675508a3a4b777d9f3016bf28676dd3c03f"),
        .binaryTarget(
            name: "EOCore",
