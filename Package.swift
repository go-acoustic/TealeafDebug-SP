...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.318/EOCore_XCFramework_Debug.zip",
            checksum: "0259ce4e74accf47df3f12328bfa5638fc4b9803bab2fffd1abf5e8411a13833"),
    ]
)
