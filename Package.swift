...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.195/Tealeaf_XCFramework_Debug.zip",
            checksum: "3dc93940a1587290e9c4a7d1e7d917f4a4d51b697f9a40467b3ad1e0229d661d"),
        .binaryTarget(
            name: "EOCore",
