...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.218/Tealeaf_XCFramework_Debug.zip",
            checksum: "0ad011f8dadd342095bfed3880aa12fa1d568c832cad5f2d9a37131225191e0c"),
        .binaryTarget(
            name: "EOCore",
