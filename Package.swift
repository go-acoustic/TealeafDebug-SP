...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.299/EOCore_XCFramework_Debug.zip",
            checksum: "4663a34eacab66806729046e5d8c3265a43c5888d65f5989b1c4b26188c2b842"),
    ]
)
