...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/go-acoustic/Tealeaf/releases/download/10.6.310/Tealeaf_XCFramework_Debug.zip",
            checksum: "aedd5aa4ae0a892e0f56f1218aa853589332305bffebf9912be98b97c9368c78"),
        .binaryTarget(
            name: "EOCore",
