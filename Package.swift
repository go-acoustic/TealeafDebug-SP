...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.193/Tealeaf_XCFramework_Debug.zip",
            checksum: "1c1c5c74e2e9d9eef09e545861eeb203bf39ede2daa3e15379ac68c01e12eaad"),
        .binaryTarget(
            name: "EOCore",
