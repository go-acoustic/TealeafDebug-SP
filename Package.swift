...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.315/EOCore_XCFramework_Debug.zip",
            checksum: "7925caa855725f048440e555b7e8aad844297fc9e20076a4cda2ab5a9d1ef530"),
    ]
)
