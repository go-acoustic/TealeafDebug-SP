...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.263/Tealeaf_XCFramework_Debug.zip",
            checksum: "74a9fd82a741cec560f8f53044e3864700f169191f563c44c603d3de05ddf682"),
        .binaryTarget(
            name: "EOCore",
