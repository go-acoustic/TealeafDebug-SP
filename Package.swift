...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.124/Tealeaf_XCFramework_Debug.zip",
            checksum: "38257906b5afff2ad698c23adcfcec6b7c1f10644033169d2f7edbf1ed0e620d"),
        .binaryTarget(
            name: "EOCore",
