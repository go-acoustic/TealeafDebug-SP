...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.105/Tealeaf_XCFramework_Debug.zip",
            checksum: "dcd1104b7b1190254c4a156cfb60a0e0fdd5b606848efca80e68828f903a1f97"),
        .binaryTarget(
            name: "EOCore",
