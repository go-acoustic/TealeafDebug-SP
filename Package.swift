...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.192/Tealeaf_XCFramework_Debug.zip",
            checksum: "a867e71997ed01b91be9a7fa7c55bf2af986921860be0f064558fd4e48ece3fa"),
        .binaryTarget(
            name: "EOCore",
