...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.235/Tealeaf_XCFramework_Debug.zip",
            checksum: "5924fc7223c8544d2f93629716d011d22adb8edcf5af5ac91a11afd2a4ffb665"),
        .binaryTarget(
            name: "EOCore",
