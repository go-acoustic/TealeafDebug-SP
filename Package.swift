...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.197/Tealeaf_XCFramework_Debug.zip",
            checksum: "57cc7a82df0f3c8cee4df1ed2ea465f0f7a0f0cb79f0799101ad3dec62e8fb34"),
        .binaryTarget(
            name: "EOCore",
