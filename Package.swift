...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.277/Tealeaf_XCFramework_Debug.zip",
            checksum: "b2fe7ef2b6888ad6c84506a42c27fafce690f19ffc3841407aa56ffce5c7785d"),
        .binaryTarget(
            name: "EOCore",
