...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.130/Tealeaf_XCFramework_Debug.zip",
            checksum: "734fb058ccd77ffe5832dfbf0a396dfabb953e17a0c4ad1d214e17ddd0706f07"),
        .binaryTarget(
            name: "EOCore",
