...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.244/Tealeaf_XCFramework_Debug.zip",
            checksum: "86cd9eda9b7f89c91bcbd57cb1b1793d3c6d38f6f9b51b505387114a3417557b"),
        .binaryTarget(
            name: "EOCore",
