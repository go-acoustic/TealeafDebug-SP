...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.216/Tealeaf_XCFramework_Debug.zip",
            checksum: "2f2ca05f0ba625e880065eb2aeab46a2879e2ac806f775f9cc4420c6dde30ab4"),
        .binaryTarget(
            name: "EOCore",
