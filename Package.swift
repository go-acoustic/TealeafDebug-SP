...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.219/Tealeaf_XCFramework_Debug.zip",
            checksum: "5f5565fe30bfe0f91392e130104df31c5d92aeb221a6ffef4649d3a640e8e15c"),
        .binaryTarget(
            name: "EOCore",
