...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.267/Tealeaf_XCFramework_Debug.zip",
            checksum: "9f25b2560d86495f757d9bfe0f3ea0ee1320bc80975c3a8878494c50cc7aa89e"),
        .binaryTarget(
            name: "EOCore",
