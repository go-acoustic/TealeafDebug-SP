...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/IBMTealeaf/releases/download/10.6.82/Tealeaf_XCFramework_Debug.zip",
            checksum: "8f537abf34b875af15373eed712687c3027db451488b007ad31abe7fe0cf947d"),
        .binaryTarget(
            name: "EOCore",
