...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.310/EOCore_XCFramework_Debug.zip",
            checksum: "6531ebb2e9f64167078ee9cb97804170a0a0daeece8482ea856a1e0cec24b5e5"),
    ]
)
