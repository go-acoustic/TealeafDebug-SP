...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.243/Tealeaf_XCFramework_Debug.zip",
            checksum: "97cd824dd0c2b704b65b0be74c69db9db34a91e3f4c22c25d7d8237db64a1f5f"),
        .binaryTarget(
            name: "EOCore",
