...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.196/Tealeaf_XCFramework_Debug.zip",
            checksum: "473b40ede50e189d3a23e4e5de939261e7ad29a61db6011830d7b7a3e326c145"),
        .binaryTarget(
            name: "EOCore",
