...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            checksum: "071ceb9efa5aad8d831e1c5a7cf7a4003f75df81594bcff614fc688a1aa9e012"),
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.296
/EOCore_XCFramework_Debug.zip",
            checksum: "Not"),
    ]
)
