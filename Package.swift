...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.308/EOCore_XCFramework_Debug.zip",
            checksum: "ac148811886dae6f57c8713fdd78589d46008a0fc68cebd8e35f2eea24e63ced"),
    ]
)
