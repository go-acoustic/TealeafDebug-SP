...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.305/EOCore_XCFramework_Debug.zip",
            checksum: "5c0588b20f73b655766bed6c0488c20a0c3589e58de2a363fd000ab7fe771218"),
    ]
)
