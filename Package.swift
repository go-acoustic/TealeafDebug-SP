...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.95/Tealeaf_XCFramework_Debug.zip",
            checksum: "842d084342ad5d4ca25892075806c7cf7ab41ee47e5d6f0978abf2e3313615ef"),
        .binaryTarget(
            name: "EOCore",
