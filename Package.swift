...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.90/Tealeaf_XCFramework_Debug.zip",
            checksum: "b7edbe57906f4c6034d0b2ba88cfdf8828d49faf582d582e0b436884b39a51f7"),
        .binaryTarget(
            name: "EOCore",
