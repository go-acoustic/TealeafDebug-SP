...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.92/Tealeaf_XCFramework_Debug.zip",
            checksum: "446e1230da157644b38e6f40599cb130681d1f08547fdc7adad2bf0840e16891"),
        .binaryTarget(
            name: "EOCore",
