...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/IBMTealeaf/releases/download/10.6.81/Tealeaf_XCFramework_Debug.zip",
            checksum: "419e8c72414dc845938372642b45aa7f0c29697abebfb193af776936ca74d613"),
        .binaryTarget(
            name: "EOCore",
