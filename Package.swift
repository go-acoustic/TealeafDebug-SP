...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/go-acoustic/Tealeaf/releases/download/10.6.334/Tealeaf_XCFramework_Debug.zip",
            checksum: "66ec8d75fd1dc96920e306ba181484d5d850d91aa75c55209f7e5bdc78a814a2"),
        .binaryTarget(
            name: "EOCore",
