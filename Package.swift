...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.246/Tealeaf_XCFramework_Debug.zip",
            checksum: "41a30264c039736bc04c91bc269a097092603d4028f2ede6e3d1d100cefaf842"),
        .binaryTarget(
            name: "EOCore",
