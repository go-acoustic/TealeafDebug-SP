...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/go-acoustic/Tealeaf/releases/download/10.6.318/Tealeaf_XCFramework_Debug.zip",
            checksum: "5dac3521312a98d25eeb1f12f4dd3c215d7e292d902a5966f04ef2e2867adf93"),
        .binaryTarget(
            name: "EOCore",
