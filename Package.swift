...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.314/EOCore_XCFramework_Debug.zip",
            checksum: "041c832dfed99fb0a9fee0276f00bd4809fdcd26d86ad004afd106e9607579d2"),
    ]
)
