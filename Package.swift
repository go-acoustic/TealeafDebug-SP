...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.282/EOCore_XCFramework_Debug.zip",
            checksum: "388084ab5f107d412630fc4a6c6112d0696e2ea883b027e76120710643e91909"),
    ]
)
