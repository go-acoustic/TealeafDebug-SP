...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.262/Tealeaf_XCFramework_Debug.zip",
            checksum: "a8f336d4f3b22e15f23b561adde60134071585b351032fcfdedc99a6881ae729"),
        .binaryTarget(
            name: "EOCore",
