...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.242/Tealeaf_XCFramework_Debug.zip",
            checksum: "40c7ac38070c0e7a90c027449307b78c14e641daf3dcf7944fa67dd3ca14abd3"),
        .binaryTarget(
            name: "EOCore",
