...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.306/EOCore_XCFramework_Debug.zip",
            checksum: "2ac12a3e2f5e9d8bc66b1d4254db0e229c07aa83fbd583984d343751f0d6e496"),
    ]
)
