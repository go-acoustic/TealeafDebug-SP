...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.199/Tealeaf_XCFramework_Debug.zip",
            checksum: "6e57fcc5bc6e4384e9af64f7b9ac693629a2b9b485f24865f73efa21b1792c9c"),
        .binaryTarget(
            name: "EOCore",
