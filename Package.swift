...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.155/Tealeaf_XCFramework_Debug.zip",
            checksum: "d09747bde62a66e089857810994f0c5ddfa1a7babccf6744e3ffca73f6a60b01"),
        .binaryTarget(
            name: "EOCore",
