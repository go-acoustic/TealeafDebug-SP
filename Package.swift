...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/go-acoustic/Tealeaf/releases/download/10.6.281/Tealeaf_XCFramework_Debug.zip",
            checksum: "1c6f30986025bd05f09832c2f7418f979d53a9c133166d12d17bc9a595d1cd56"),
        .binaryTarget(
            name: "EOCore",
