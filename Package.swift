...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/go-acoustic/Tealeaf/releases/download/10.6.282/Tealeaf_XCFramework_Debug.zip",
            checksum: "61120308cc36cb5e17d96d163c0d88f7d4898e48c35ab1643e4f0df54c9e1da9"),
        .binaryTarget(
            name: "EOCore",
