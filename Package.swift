...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/acoustic-analytics/EOCore/releases/download/2.3.263/EOCore_XCFramework_Debug.zip",
            checksum: "88121bd58cba0b91559885f92eaf1d2f25455a979bad2a4f6becd96a991efe8d"),
    ]
)
