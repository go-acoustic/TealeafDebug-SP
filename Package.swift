...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.261/Tealeaf_XCFramework_Debug.zip",
            checksum: "b62cad0547c8ff2a046813a1c03eeabb709d279e3f5b479e0dc7f493887bc848"),
        .binaryTarget(
            name: "EOCore",
