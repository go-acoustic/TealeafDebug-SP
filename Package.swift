...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.300/EOCore_XCFramework_Debug.zip",
            checksum: "4c886bde16968b210dd5e3b48327f80c200d89125dd44455fd1e6b5d4587b983"),
    ]
)
