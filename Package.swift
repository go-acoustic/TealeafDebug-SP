...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.277/EOCore_XCFramework_Debug.zip",
            checksum: "84043da51a582c68e75f8b21af2ef011c62cafc17f50b0152d0d68ce5f9aba5f"),
    ]
)
