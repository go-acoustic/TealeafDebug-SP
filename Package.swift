...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.194/Tealeaf_XCFramework_Debug.zip",
            checksum: "609f58877eb12ce40bafd134fea2efe6f58dee9ce458429a47b9d2245c7b22f8"),
        .binaryTarget(
            name: "EOCore",
