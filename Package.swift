...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.170/Tealeaf_XCFramework_Debug.zip",
            checksum: "5c81ef81b90bea9d363c09d535d9c09d2fcd5fc7e8b5236a360c68cfd61d95d3"),
        .binaryTarget(
            name: "EOCore",
