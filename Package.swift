...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.221/Tealeaf_XCFramework_Debug.zip",
            checksum: "1bb8680eb68977ed90fd261d5d01454729e9e710da754f935948a941061271d1"),
        .binaryTarget(
            name: "EOCore",
