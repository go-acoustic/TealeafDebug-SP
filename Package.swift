...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EOCore",
            url: "https://github.com/go-acoustic/EOCore/releases/download/2.3.280/EOCore_XCFramework_Debug.zip",
            checksum: "f91a40537bac6ea7b5937da5b7b69da3062164e51bdfb54e00a55f3092417333"),
    ]
)
